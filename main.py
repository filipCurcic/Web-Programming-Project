...
app.config['SECRET_KEY'] = 'nekitajnikljuc'
...
def testiranje():
    ...
    return make_response("asd", 401, {'WWW-Authenticate': 'Basic realm="Login Required'})
...
def token_required(f):
    ...
    def decorated(*args, **kwargs):
        ...
        try:
            ...
            return flask.jsonify({'message': 'Token is invalid'}), 403
